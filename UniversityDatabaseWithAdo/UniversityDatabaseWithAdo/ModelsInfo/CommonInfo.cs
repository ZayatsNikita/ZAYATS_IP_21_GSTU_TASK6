...
namespace University
{
    ...
    public class CommonInfo : IComparable<CommonInfo>
    {
        ...
        public CommonInfo(int groupId, int studentId,string studentFio,string studentSex, DateTime studentBirthday, int examID, int numberOfSession, int mark)
        {
        ...
        private static Func<CommonInfo, CommonInfo, int> _comparator = (x, y) => 0;
