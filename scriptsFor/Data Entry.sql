...
((select id from Student where FIO ='Tsmyg Dmitry Alexandrovich'), (select id from ExamInfo where ExamId = (select id from Exam where NameOfExam = 'Mechanics' and DatOfTheExam = '2019-01-01')),8)
